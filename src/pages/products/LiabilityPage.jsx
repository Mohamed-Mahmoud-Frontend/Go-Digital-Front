...
export const LiabilityPage = () => {
    ...
    return (
        <>
            ...
            <HeroProductsSection
                headTitle={t('liability_page.hero_section.headTitle')}
                Subtitle={t('liability_page.hero_section.subtitle')}
                url="/get-a-quote-liability"
            >
                <h3 data-aos="fade-right" className="text-sm sm:text-base lg:text-[22px] font-bold">
                    {t('liability_page.hero_section.cta_text')}
                </h3>
                <input
                    data-aos="fade-right"
            ...
            <section className="mb-0 sm:mb-24">
                <h1 data-aos="zoom-in" className="text-center text-2xl lg:text-[40px] font-bold my-10 sm:my-12">
                    {t('liability_page.how_works_section.title')}
                </h1>
            ...
            <CoveragesSection
                title={t('liability_page.coverages_section.title')}
                description={t('liability_page.coverages_section.description')}
                data={slidesData}
            />
            ...
            <section className="bg-secondaryColor mx-7 lg:mx-20 rounded-b-3xl md:rounded-b-[58px] rounded-t-[30px] md:rounded-t-[70px] my-5 md:my-20">
                ...
                <div data-aos="fade-right" className="flex flex-wrap gap-3 vsm:gap-5 justify-center xl:justify-evenly items-center rounded-3xl md:rounded-b-[58px] text-center py-10 sm:py-16 mx-1 vsm:mx-4 xl:mx-20">
                    {t('liability_page.why_section.features', { returnObjects: true }).map((feature, index) => (
            ...
            <ArticleSlider
                subTitle={t('liability_page.article_slider.subTitle')}

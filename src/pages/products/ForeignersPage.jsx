...
export const ForeignersPage = () => {
    ...
    return (
        <>
            ...
            <HeroProductsSection
                headTitle={t('foreigners_page.hero_section.headTitle')}
                Subtitle={t('foreigners_page.hero_section.subtitle')}
                url="/get-a-quote-foreigners"
            >
                <h3 data-aos="fade-right" className="text-sm sm:text-base lg:text-[22px] font-bold">
                    {t('foreigners_page.hero_section.cta_text')}
                </h3>
                <input
                    data-aos="fade-right"
                    type="text"
            ...
            <section className="mb-0 sm:mb-24">
                <h1 data-aos="zoom-in" className="text-center text-2xl lg:text-[40px] font-bold my-10 sm:my-12">
                    {t('foreigners_page.how_works_section.title')}
                </h1>
            ...
            <CoveragesSection
                title={t('foreigners_page.coverages_section.title')}
                description={t('foreigners_page.coverages_section.description')}
                data={slidesData}
            />

...
const PaymentSuccess = () => {
  ...
  const product =
    contract.product || localStorage.getItem("lastProduct") || "travel";
        ...
        <section className="flex flex-col gap-4 md:max-w-[422px]">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-5">
            ...
            <button
              ...
              className="w-52 h-12 bg-green-600 font-semibold text-lg text-white rounded-[10px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.15)] hover:bg-green-700 transition-all duration-300 flex items-center justify-center gap-2"
            >
              <svg
                className="w-5 h-5"
                fill="none"

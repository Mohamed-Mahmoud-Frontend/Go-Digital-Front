        ...
        <Fragment>
            ...
            <main className="flex max-md:flex-col gap-10 justify-center md:items-center mx-5 sm:mx-10 my-10 md:my-20">
                <section className="flex flex-col gap-4 md:max-w-[422px]">
                    <PaymentSuccessIcon />
                    <h1 className="Inter_font text-xl md:text-2xl font-medium text-secondaryColor">Όλα έτοιμα! <br /> Η Ασφάλεια σου έχει εκδοθεί!</h1>
                    <p className="font-semibold">Ευχαριστούμε που έχεις επιλέξει την GoDigital για την ασφάλιση σου!</p>
                ...
                <section className="flex flex-col gap-1 md:max-w-[600px] bg-red-200/40 rounded-3xl px-7 md:px-11 py-7 md:py-12 md:text-sm Inter_font">
                    <p className="mb-6">Όλα τα απαραίτητα έγγραφα έχουν ήδη αποσταλεί στο email δήλωσες και μπορείς να αποκτήσεις πρόσβαση σε αυτά οποιαδήποτε στιγμή με το να συνδεθείτε στον λογαριασμό σου.</p>
